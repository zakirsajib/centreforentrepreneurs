...
<div class="owl-carousel-twitter">
        <?php foreach($tweets as $tweet):?>
            <div class="item span12">
                <div class="span2">
                    <a href="https://twitter.com/CfEntrepreneurs" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/includes/images/twt-cfe.jpg" alt=""></a>
                </div>
                <div class="caption span10">
			        ...
			        # Output
			        echo '<a class="twitter-user" href="https://twitter.com/CfEntrepreneurs" target="_blank">CfEntrepreneurs</a>';
